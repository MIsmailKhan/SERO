...
if("TRUE" STREQUAL "TRUE")
  set(collada_urdf_SOURCE_PREFIX /home/ismail/catkin_ws2/src/my_personal_robotic_companion/robot_model/collada_urdf)
  set(collada_urdf_DEVEL_PREFIX /home/ismail/catkin_ws2/devel)
  ...
  set(collada_urdf_INSTALL_PREFIX /home/ismail/catkin_ws2/install)
...
if(NOT "/home/ismail/catkin_ws2/src/my_personal_robotic_companion/robot_model/collada_urdf/include " STREQUAL " ")
  set(collada_urdf_INCLUDE_DIRS "")
  set(_include_dirs "/home/ismail/catkin_ws2/src/my_personal_robotic_companion/robot_model/collada_urdf/include")
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'collada_urdf' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/ismail/catkin_ws2/src/my_personal_robotic_companion/robot_model/collada_urdf/${idir}'.  Ask the maintainer 'Ioan Sucan <isucan@gmail.com>' to fix it.")
    endif()
